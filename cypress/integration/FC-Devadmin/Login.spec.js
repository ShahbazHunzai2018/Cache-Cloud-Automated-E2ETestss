...
describe('Login', () => {
    beforeEach(() => {
      ...
      cy.visit('https://dev.planeths.com/?keyword=%2Fuser%2Fsignin&schoolID=0')
        .wait(2000)
})
it('Should go to the Login Page and Login for the new User', () => {
    cy.get('#user-email-mobile').click().type('shahbaz.khan@cache-cloud.com')
      .wait(2000)
      .get('#user-password').click().type('Neelambano2016')
      .wait(2000)
